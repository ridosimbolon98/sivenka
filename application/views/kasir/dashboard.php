                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Rp 1.540.000</div>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Report rekap perbulan</h6>
            ...
            <div class="col-xl-4 col-lg-5">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <div class="dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                      ...
                      <a class="dropdown-item active" href="#">Bulanan</a>
                ...
                <div class="card-body">
                  <div class="mb-3">
                    <div class="small text-gray-500">Oblong T-Shirt
                      <div class="small float-right"><b>600 dari 800 Items</b></div>
                    </div>
                  ...
                  <div class="mb-3">
                    <div class="small text-gray-500">Gundam 90'Editions
                      <div class="small float-right"><b>500 dari 800 Items</b></div>
                    </div>
                    <div class="progress" style="height: 12px;">
                  ...
                  <div class="mb-3">
                    <div class="small text-gray-500">Rounded Hat
                      <div class="small float-right"><b>455 dari 800 Items</b></div>
                    </div>
                    <div class="progress" style="height: 12px;">
                  ...
                  <div class="mb-3">
                    <div class="small text-gray-500">Indomie Goreng
                      <div class="small float-right"><b>400 dari 800 Items</b></div>
                    </div>
                    <div class="progress" style="height: 12px;">
                  ...
                  <div class="mb-3">
                    <div class="small text-gray-500">Remote Control
                      <div class="small float-right"><b>200 dari 800 Items</b></div>
                    </div>
                    <div class="progress" style="height: 12px;">
                ...
                <div class="card-footer text-center">
                  <a class="m-0 small text-primary card-link" href="#">Tampilkan lebih lanjut <i
