        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="../daftar_suplier">Suplier</a></li>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-3">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Detail Suplier dengan Kode: <?= $id_suplier ?></h6>
                </div>
                <div class="table-responsive p-3">

                <?php foreach ($suplier as $row): ?>
                  <form action="<?= base_url('admin/ubah_suplier') ?>" method="post">
                    <div class="form-group row">
                      <label for="inputKode" class="col-sm-3 col-form-label">Kode Suplier</label>
                      <div class="col-sm-9">
                        <input name="kode_suplier" type="hidden" class="form-control" value="<?= $row->id_suplier ?>">
                        <input type="text" disabled class="form-control" id="inputKode" value="<?= $row->id_suplier ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputNamaSuplier" class="col-sm-3 col-form-label">Nama Suplier</label>
                      <div class="col-sm-9">
                        <input name="nama_suplier" type="text" class="form-control" id="inputNamaSuplier" value="<?= $row->nama_suplier ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputAlamat" class="col-sm-3 col-form-label">Alamat</label>
                      <div class="col-sm-9">
                        <textarea class="form-control" name="alamat_suplier" id="inputAlamat" cols="30" rows="3" required><?= $row->alamat ?></textarea>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="inputNoTelp" class="col-sm-3 col-form-label">No Telp</label>
                      <div class="col-sm-9">
                        <input name="no_telp" type="text" class="form-control" value="<?= $row->no_telp ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input name="no_hp" type="text" class="form-control" value="<?= $row->no_hp ?>" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-sm-3 col-form-label">Status</label>
                      <div class="col-sm-9">
                        <input type="text" disabled class="form-control" value="<?= $row->status_suplier ? 'ENABLED':'DISABLED' ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-sm-3 col-form-label">Input By</label>
                      <div class="col-sm-9">
                        <input type="text" disabled class="form-control" value="<?= $row->input_by ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-sm-3 col-form-label">Tanggal Input</label>
                      <div class="col-sm-9">
                        <input type="text" disabled class="form-control" value="<?= $row->tgl_input ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="" class="col-sm-3 col-form-label">Tanggal Update</label>
                      <div class="col-sm-9">
                        <input type="text" disabled class="form-control" value="<?= $row->tgl_update ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="btnUpdate" class="col-sm-3 col-form-label"></label>
                      <div class="col-sm-9">
                        <button class="btn btn-primary" onclick="return confirm('Apakah anda yakin ubah data suplier?')"> Simpan Perubahan</button>
                      </div>
                    </div>
                  </form>
                <?php endforeach ?>
